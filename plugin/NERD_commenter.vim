...
call s:CreateMaps('nx', 'Comment',    'Comment', '')
call s:CreateMaps('nx', 'Toggle',     'Toggle', '')
call s:CreateMaps('nx', 'Minimal',    'Minimal', '')
call s:CreateMaps('nx', 'Nested',     'Nested', '')
call s:CreateMaps('n',  'ToEOL',      'To EOL', '')
call s:CreateMaps('nx', 'Invert',     'Invert', '')
call s:CreateMaps('nx', 'Sexy',       'Sexy', '')
call s:CreateMaps('nx', 'Yank',       'Yank then comment', '')
call s:CreateMaps('n',  'Append',     'Append', '')
call s:CreateMaps('',   ':',          '-Sep-', '')
call s:CreateMaps('nx', 'AlignLeft',  'Left aligned', '')
call s:CreateMaps('nx', 'AlignBoth',  'Left and right aligned', '')
call s:CreateMaps('',   ':',          '-Sep2-', '')
call s:CreateMaps('nx', 'Uncomment',  'Uncomment', '')
call s:CreateMaps('n',  'AltDelims',  'Switch Delimiters', '')
